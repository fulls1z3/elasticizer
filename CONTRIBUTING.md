# Contributing to elasticizer

We would love for you to contribute to **`elasticizer`** and help make it even better than it is today! As a contributor,
...
Help us keep **`elasticizer`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/fulls1z3/elasticizer/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/fulls1z3/elasticizer/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `elasticizer:master`.
...
Samples: (even more [samples](https://github.com/fulls1z3/elasticizer/commits/master))
```
...
* **core** (*elasticizer.core*)
* **domain** (*elasticizer.domain*)
...
[coc]: https://github.com/fulls1z3/elasticizer/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/fulls1z3/elasticizer
